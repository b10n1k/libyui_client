...
#    LibyuiClient.kill_app
  ...
  context "Running non-destructive scenarios:" do
    it "yast2 host" do
      LibyuiClient.start_app("/usr/sbin/yast2 host", '192.168.121.99')
      #LibyuiClient.attach('192.168.121.99', 9999)
      LibyuiClient.find_widget(id: '', debug_label: 'Host Configuration')
